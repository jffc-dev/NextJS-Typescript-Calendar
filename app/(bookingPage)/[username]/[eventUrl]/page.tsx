...
import { Calendar as CalendarIcon, Clock, VideoIcon } from "lucide-react"
            ...
            {showForm ? (
                <Card className="max-w-[600px] w-full">
                    <CardContent className="p-5 md:grid md:grid-cols-[1fr,auto,1fr] gap-4">
                        <div>
                            <img src={data.User?.image as string} alt="Profile Image of user"
                ...
                <Card className="max-w-[1000px] w-full mx-auto">
                    <CardContent className="p-5 md:grid md:grid-cols-[1fr,auto,1fr,auto,1fr] gap-4">
                        ...
                        <RenderCalendar availability={data.User?.availabilities as any}/>
